            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('dashboard') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="flex-1 max-w-md" x-data="{ search: '{{ request('search') }}' }">
                        <form action="{{ route('admin.userPanel.search') }}" method="GET" x-ref="searchForm">
                            <div class="relative">
                                <input type="text"
                                    name="search"
                                    x-model="search"
